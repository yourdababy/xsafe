        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                ...
                <div class="navbar-search-block">
                    <form class="form-inline" action="?aaa=xxx" method="get">
                        <div class="input-group input-group-sm">
                            <input name="keywords" class="form-control form-control-navbar" value="{{ .keywords }}" type="search" placeholder="搜索文章..." aria-label="Search">
